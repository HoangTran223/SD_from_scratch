...
class CrossAttention(nn.Module):
    def __init__(self, n_heads: int, d_embed: int, d_cross: int, int_proj_bias=True, out_proj_bias=True):
        super().__init__()

        self.q_proj = nn.Linear(d_embed, d_embed, bias=int_proj_bias)
        self.k_proj = nn.Linear(d_cross, d_embed, bias=int_proj_bias)
        self.v_proj = nn.Linear(d_cross, d_embed, bias=int_proj_bias)
        self.out_proj = nn.Linear(d_embed, d_embed, bias=out_proj_bias)
